...
const styles = StyleSheet.create({
  ...
  routeName: { fontSize: 16, fontWeight: '800', color: '#142B4A' },
  schoolName: { fontSize: 12, color: '#047857', fontWeight: '600', marginTop: 2 },
  priceBox: { alignItems: 'flex-end' },
  priceVal: { fontSize: 18, fontWeight: '800', color: '#F07832' },
  ...
  timeText: { fontSize: 12, color: '#142B4A', fontWeight: '600', marginTop: 2 },
  stopsBox: {
  ...
  seatsLeft: { fontSize: 12, fontWeight: '700', color: '#142B4A' },

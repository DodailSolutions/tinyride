      ...
      <div className="p-8 space-y-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/cms"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-brand-navy-800 text-white font-medium text-sm hover:bg-brand-navy-900 shadow-sm transition-colors"
            >
              <Sliders className="w-4 h-4 text-brand-orange-400" />
              Manage Website CMS
            </Link>
            <Link
              href="/routes"
